...
def undistort_fisheye624(image, camera_name, destination_params, batch_size=1024, device="cuda"):
    ...
    print("Shape of the meshgrid: ", y_coords.shape, x_coords.shape)
    print("Meshgrid: ", y_coords, x_coords)
    ...
    with torch.no_grad():
        for batch_idx in tqdm(range(num_batches), desc="Undistorting image"):
            ...
            # print("Normalized coordinates: ", x_norm[0], y_norm[0])
            ...
            phi = torch.atan2(y_norm, x_norm) ## This is equal to tan.inv(y_norm/x_norm) 
