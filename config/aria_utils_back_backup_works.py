...
if __name__ == '__main__':
    ...
    converter_kb6 = AriaCameraModelConverter(
        aria_fisheye_intrinsics_kb6, 
    ...
    # Display results
    # draw principle point on both the images at their respective positions
    ...
    cv2.circle(distorted_image, original_principal_point, 5, (0, 0, 255), -1)
    cv2.circle(undistorted_image_kb6, pinhole_principal_point, 5, (0, 0, 255), -1)

    cv2.imshow("Original", distorted_image)
    cv2.imshow("Undistorted", undistorted_image_kb6)
    cv2.waitKey(0)
